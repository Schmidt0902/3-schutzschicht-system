...
class TripleShieldSystem:
    ...
    def describe_layer(self, layer):
        if layer == 1:
            return self.cage.describe()
        elif layer == 2:
            return self.composite.describe()
        elif layer == 3:
            return self.module.encapsulation.describe()
        elif layer == "module":
    ...
    def describe_all(self):
        return {
            "Layer 1": self.cage.describe(),
            "Layer 2": self.composite.describe(),
            "Layer 3": self.module.encapsulation.describe(),
...
layer1 = system.describe_layer(1)
layer2 = system.describe_layer(2)
layer3 = system.describe_layer(3)
module_info = system.describe_layer("module")
